drop table if exists recommend_set_user_set_user;
create table recommend_set_user_set_user as
select * from(
select a.user_id as user_id, a.item_id as item_id, 
	...
	a.is_buy as is_buy 
from recommend_set_user_item a left outer join recommend_set_user b
on a.user_id = b.user_id)aa;

drop table if exists recommend_set;
create table recommend_set as
select * from(
select a.user_id as user_id, a.item_id as item_id, 
    a.beh_rate1 as beh_rate1, a.beh_rate2 as beh_rate2, a.beh_rate3 as beh_rate3, a.beh_rate4 as beh_rate4, 
    a.is_finalday_occur1 as is_finalday_occur1, a.is_finalday_occur2 as is_finalday_occur2, a.is_finalday_occur3 as is_finalday_occur3, a.is_finalday_occur4 as is_finalday_occur4, 
	...
	a.is_buy as is_buy 
from recommend_set_user_set_user a left outer join recommend_set_item b
